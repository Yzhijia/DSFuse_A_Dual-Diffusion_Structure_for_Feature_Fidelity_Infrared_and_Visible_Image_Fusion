...
from utils.utils import plot_img, move_to_cuda, load_checkpoint_total, save_checkpoint_total, tensors_to_scalars, load_ckpt, Measure
...
class Trainer:
    ...
    def build_train_dataloader(self):
        dataset = Fusion_Dataset(hparams['path_ir'], hparams['path_vi'], hparams['path_mask'],
                                 hparams['crop_size'], hparams['upscale_factor'], prefix='train')
        if opt['rank'] == 0:
    ...
    def train(self):
        ...
        self.global_step = training_step = load_checkpoint_total(model, optimizer_d, hparams['work_dir'])
        ...
        self.scheduler_d = scheduler_d = self.build_scheduler(optimizer_d)
            ...
            for batch in train_pbar:
                ...
                if opt["rank"] == 0:
                    if training_step % hparams['val_check_interval'] == 0:
                        ...
                        save_checkpoint_total(model, optimizer_d, self.work_dir,
...
if __name__ == '__main__':
    ...
    trainer = task.fusiondiff.FusionDiffTrainer_Swin()
